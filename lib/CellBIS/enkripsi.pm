...
sub nkti_odd_index {
    ...
    my @arr_string = CellBIS::Utils::Char->split_blen($string, 1);
...
sub nkti_extract_odd2even {
    ...
    my @arr_odd = CellBIS::Utils::Char->split_blen(substr($string, 0, $len_odd), 1);
    my @arr_even = CellBIS::Utils::Char->split_blen(substr($string, $len_odd, $len_even), 1);
...
sub nkti_extract_even2odd {
    ...
    my $len_odd = length $get_odd;
    my $len_even = length $get_even;
    my @arr_even = CellBIS::Utils::Char->split_blen(substr($string, 0, $len_even), 1);
    my @arr_odd = CellBIS::Utils::Char->split_blen(substr($string, $len_even, $len_odd), 1);
